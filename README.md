...
This project assumes that you are running the version Node.js specified in the `.nvmrc` file. [NVM](https://github.com/creationix/nvm) is recommended to make sure that you're running the proper version of Node.js for this project.
...
4.  Run the following commands to start the ddev container and get WordPress installed:
    ...
    ddev wp core download --skip-content || true
...
To work on this site, you can run the following commands:
